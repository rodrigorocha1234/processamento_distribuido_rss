...
lista_urls = [
    {
    'url_origem': 'ribeirao_preto',
    'url_base': 'https://g1.globo.com/rss/g1/sp/ribeirao-preto-franca/'
    }, {
'url_origem': 'para',
    'url_base': 'https://g1.globo.com/dynamo/pa/para/rss2.xml'
    }]
for url in lista_urls:
    web_scraping_rss.url = url['url_base']
            ...
            if isinstance(motor_g1, BeautifulSoup):
                ...
                if noticia_g1.texto:
                    ...
                    if isinstance(url_g1, str):
                        ...
                        servico_arquivo.nome_arquivo =  os.path.join('noticias', url['url_origem'],  nome_arquivo)
                        print(servico_arquivo.nome_arquivo.split('/')[0])
                        print(servico_arquivo.nome_arquivo.split('/')[1])
